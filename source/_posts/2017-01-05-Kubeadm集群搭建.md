...
具体请参考：[kubeadm-config.yml](/files/config.rar)
...
具体请参考：[kubernetes-dashboard.yaml](/files/config.rar)
...
NAME                                       READY     STATUS    RESTARTS   AGE       IP             NODE
po/elasticsearch-logging-v1-3w2mr          1/1       Running   0          52m       10.244.100.6   k8s-node1
po/elasticsearch-logging-v1-rv2mt          1/1       Running   0          52m       10.244.66.3    k8s-node2
po/fluentd-es-v1.22-bcqvn                  1/1       Running   0          52m       10.244.66.4    k8s-node2
po/fluentd-es-v1.22-cf0fm                  1/1       Running   0          52m       10.244.100.7   k8s-node1
po/heapster-1528902802-8ht2k               1/1       Running   0          7h        10.244.100.5   k8s-node1
po/kibana-logging-3757371098-bjrlh         1/1       Running   0          52m       10.244.15.2    k8s-master
po/kube-apiserver-k8s-master               1/1       Running   6          1d        192.168.10.6   k8s-master
po/kube-controller-manager-k8s-master      1/1       Running   28         2d        192.168.10.6   k8s-master
po/kube-dns-1783747724-3jb47               3/3       Running   6          1d        10.244.100.2   k8s-node1
po/kube-proxy-3l1wf                        1/1       Running   9          3d        192.168.10.7   k8s-node1
po/kube-proxy-5mwcl                        1/1       Running   11         3d        192.168.10.8   k8s-node2
po/kube-proxy-s02wm                        1/1       Running   8          3d        192.168.10.6   k8s-master
po/kube-scheduler-k8s-master               1/1       Running   29         2d        192.168.10.6   k8s-master
po/kubernetes-dashboard-2315583659-qt0vm   1/1       Running   15         3d        10.244.100.3   k8s-node1
po/monitoring-grafana-241275065-x764d      1/1       Running   0          5h        10.244.66.2    k8s-node2
po/monitoring-influxdb-2075516717-sqwq6    1/1       Running   0          7h        10.244.100.4   k8s-node1
po/nginx-786442954-4tw0m                   1/1       Running   0          3h        10.244.66.6    k8s-node2

NAME                        CLUSTER-IP       EXTERNAL-IP    PORT(S)                         AGE       SELECTOR
svc/elasticsearch-logging   10.97.110.114    <none>         9200/TCP                        52m       k8s-app=elasticsearch-logging
svc/heapster                10.98.170.30     <none>         80/TCP                          1d        k8s-app=heapster
svc/kibana-logging          10.106.241.106   <none>         5601/TCP                        52m       k8s-app=kibana-logging
svc/kube-dns                10.96.0.10       <none>         53/UDP,53/TCP                   3d        k8s-app=kube-dns
svc/kubernetes-dashboard    10.106.184.36    <none>         80/TCP                          3d        k8s-app=kubernetes-dashboard
svc/monitoring-grafana      10.101.89.7      <nodes>        80:30015/TCP                    1d        k8s-app=grafana
svc/monitoring-influxdb     10.104.56.131    192.168.10.6   8083:30016/TCP,8086:32638/TCP   1d        k8s-app=influxdb
svc/nginx                   10.104.243.96    <pending>      8888:32500/TCP                  3h        app=nginx

NAME                         ENDPOINTS                             AGE
ep/elasticsearch-logging     10.244.100.6:9200,10.244.66.3:9200    52m
ep/heapster                  10.244.100.5:8082                     1d
ep/kibana-logging            10.244.15.2:5601                      52m
ep/kube-controller-manager   <none>                                7h
ep/kube-dns                  10.244.100.2:53,10.244.100.2:53       3d
ep/kube-scheduler            <none>                                7h
ep/kubernetes-dashboard      10.244.100.3:9090                     3d
ep/monitoring-grafana        10.244.66.2:3000                      1d
ep/monitoring-influxdb       10.244.100.4:8086,10.244.100.4:8083   1d
ep/nginx                     10.244.66.6:80                        3h
```
