...
具体请参考：[kubeadm-config.yml](/files/Kubeadm集群搭建/config.zip)
...
参考修改后的文件：[kube-flannel.yml](/files/Kubeadm集群搭建/config.zip)
...
#### 最新方式
[https://forums.docker.com/t/docker-for-mac-kubernetes-dashboard/44116/6](https://forums.docker.com/t/docker-for-mac-kubernetes-dashboard/44116/6)
...
1.6请参考：[kubernetes-dashboard.yaml](/files/Kubeadm集群搭建/dashboard-1.6.zip)
1.7请参考：[kubernetes-dashboard.yaml](/files/Kubeadm集群搭建/dashboard-1.7.zip)
...
![dashboard_login.png](/images/Kubeadm集群搭建/dashboard_login.png)
...
```
登录后出现：
![dashboard_error1.png](/images/Kubeadm集群搭建/dashboard_error1.png)
...
具体可参考[heapster.zip](/files/Kubeadm集群搭建/heapster.zip)
...
![heapster](/images/Kubeadm集群搭建/heapster.png)
...
具体文件可参考[EFK.zip](/files/Kubeadm集群搭建/EFK.zip)
...
配置文件请参考：[prometheus.zip](/files/Kubeadm集群搭建/prometheus.zip)
