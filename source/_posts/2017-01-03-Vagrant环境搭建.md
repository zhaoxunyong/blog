...
### 配置Hyper-V网络
如果不配置网络的话，Hyper-V连接不到网络，具体请参考[https://docs.microsoft.com/en-us/virtualization/hyper-v-on-windows/quick-start/connect-to-network](https://docs.microsoft.com/en-us/virtualization/hyper-v-on-windows/quick-start/connect-to-network)
![hyperv.png](/images/hyperv.png)
