...
#Opening remote docker's api access
export DOCKER_HOST="tcp://192.168.95.233:2375"
mvn clean install fabric8:deploy -Pkubernetes
```
...
mvn -Ddocker.registry=192.168.95.233:32000 package fabric8:build fabric8:push
```
