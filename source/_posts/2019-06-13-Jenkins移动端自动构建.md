...
/opt/homebrew/opt/openjdk@11/bin/java -Dmail.smtp.starttls.enable\=false -jar /opt/homebrew/opt/jenkins-lts/libexec/jenkins.war --httpListenAddress\=0.0.0.0 --httpPort\=8080 --prefix=/ci
...
#rsync -avP jenkins@192.168.101.83:/usr/local/opt/jenkins-lts/libexec/jenkins.war /opt/homebrew/opt/jenkins-lts/libexec/
cp -a ~/Developer/jenkins-war-2.263.4.war /opt/homebrew/opt/jenkins-lts/libexec/jenkins.war
```
...
...
            ...
            <string>-Dmail.smtp.starttls.enable=false</string>
...
...
        ...
        <string>/Users/jenkins/.jenkins/logs/stdout.log</string>
        <key>StandardErrorPath</key>
        <string>/Users/jenkins/.jenkins/logs/error.log</string>
```
...
```config
    server {
        listen 443 ssl;
        server_name  appbuild.zerofinance.hk;
        server_tokens off;
        ...
        # ssl on;
        ssl_certificate      /Users/jenkins/.jenkins/ssl/zerofinance.hk/zerofinance.crt;
        ssl_certificate_key  /Users/jenkins/.jenkins/ssl/zerofinance.hk/zerofinance.key;
