...
yum -y install createrepo rpm-sign rng-tools yum-utils bind-utils bridge-utils ntpdate setuptool iptables system-config-securitylevel-tui system-config-network-tui \
